...
$sql="SELECT   'foodShow' AS board_type, A.foodShow_num AS num, A.foodShow_id AS id, B.nick AS nick, A.foodShow_subject AS subject, A.foodShow_hit AS hit, A.foodShow_date AS date,
...
try{  
  ...
  $sql_total = "SELECT   'foodShow' AS board_type, A.foodShow_num AS num, A.foodShow_id AS id, B.nick AS nick, A.foodShow_subject AS subject, A.foodShow_hit AS hit, A.foodShow_date AS date,
                          (SELECT COUNT(*) FROM joobee97.boardLike0201 WHERE boardLike_type = 'foodShow' AND A.foodShow_num = boardLike_num GROUP BY boardLike_num) AS LikeCNT,
                          substr(A.foodShow_content, instr(A.foodShow_content,'<img'), 
                                instr(substr(A.foodShow_content, instr(A.foodShow_content,'<img')), '>')) AS thumbnail 
                FROM     joobee97.foodShow0201 A, joobee97.member0201 B
...
<div id="list_write_button">
          <a href="write.php?page=<?=$page?>"><img src="../img/list.png"></a>&nbsp;
</div>
</div>
