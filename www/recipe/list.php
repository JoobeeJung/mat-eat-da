...
try{  
  ...
  $sql_total = "select * from joobee97.recipe0201";  //전체 레코드수를 파악하기 위함.
...
<div id="content3" style="width:100%; height:350px; margin-left:0px">
      <ul id= "bxslider" class="bxslider" align="center" style="width:1800px; height:600px">
      <li>
            <div title="배너1"><a href="./view.php?recipe_num=11"><img src="../img/M_banner1.png"></a></div>
          </li>
  				<li>
            <div title="배너2"><a href="./view.php?recipe_num=12"><img src="../img/M_banner2.png"></a></div>
          </li>
          <li>
            <div title="배너3"><a href="./view.php?recipe_num=8"><img src="../img/M_banner3.png"></a></div>
          </li>
          <li>
            <div title="배너4"><a href="./view.php?recipe_num=9"><img src="../img/M_banner4.png"></a></div>
          </li>
          <li>
            <div title="배너5"><a href="./view.php?recipe_num=7"><img src="../img/M_banner5.png"></a></div>
          </li>
			</ul>
    
  </div>
  <div id="right_menu" style="position: absolute; top: 300px; margin-left: 50px; width:300px"><a href="http://www.chungjungone.com/knowhow/cooking/cookingClassList.do"><img src="../img/side_banner.png"></a></div>
...
?>
          <div id="<?=$cssStr?>">
              <div id="list_content" class="snip1361">
                  <a href="view.php?recipe_num=<?=$item_num?>&page=<?=$page?>">
<?php 
if($item_img){
?>
<?=$item_img?>
